...
## POSITIONS RETIRED FROM OPERATIONAL/MAPPING VIEW

These retain deprecated placeholder status in internal governance docs/capability matrix as required; they are not represented as active in this public-facing structure mapping.

- Attorney General → replaced by Justice & Constitutional Compliance + Constitutional Court
- Secretary of Defense → not active in digital-native posture
- Director of National Intelligence / CIA / DIA / NSA → replaced by Situational Awareness + Digital Operations
- Secretary of Justice & Constitutional Compliance as standalone operational office → legacy commissioning label deprecated
- Director of Digital Operations as standalone operational office → legacy standalone office deprecated
- Director of Situational Awareness as standalone operational office → legacy standalone office deprecated
