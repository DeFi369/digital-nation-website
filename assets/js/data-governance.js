(function () {
  ...
  function renderStats() {
    const container = document.getElementById('data-governance-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('data-governance-pillars');
    if (!container) return;
    fetch('assets/data/data-governance.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    ...
    var scopeField = document.getElementById('data-governance-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('data-governance-mixed-feed', filtered);
    }
