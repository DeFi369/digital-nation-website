(function () {
  ...
  function renderStats() {
    const container = document.getElementById('symbols-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('symbols-pillars');
    if (!container) return;
    fetch('assets/data/symbols.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('symbols-search');
    var scopeField = document.getElementById('symbols-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('symbols-mixed-feed', filtered);
    }
