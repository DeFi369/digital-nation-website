(function () {
  ...
  function renderStats() {
    const container = document.getElementById('culture-stats');
    if (!container) return;
  ...
  function initFilters() {
    var searchField = document.getElementById('culture-search');
    var scopeField = document.getElementById('culture-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('culture-mixed-feed', filtered);
    }
