(function () {
  ...
  function renderStats() {
    const container = document.getElementById('consular-stats');
    if (!container) return;
    fetch('assets/data/consular.json')
  ...
  function renderPillars() {
    const container = document.getElementById('consular-pillars');
    if (!container) return;
    fetch('assets/data/consular.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('consular-search');
    var scopeField = document.getElementById('consular-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('consular-mixed-feed', filtered);
    }
