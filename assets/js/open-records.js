(function () {
  ...
  function renderStats() {
    const container = document.getElementById('open-records-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('open-records-pillars');
    if (!container) return;
    fetch('assets/data/open-records.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    ...
    var scopeField = document.getElementById('open-records-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('open-records-mixed-feed', filtered);
    }
