(function () {
  ...
  function renderStats() {
    const container = document.getElementById('emerging-tech-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('emerging-tech-pillars');
    if (!container) return;
    fetch('assets/data/emerging-tech.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    ...
    var scopeField = document.getElementById('emerging-tech-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('emerging-tech-mixed-feed', filtered);
    }
