(function () {
  ...
  function renderStats() {
    const container = document.getElementById('diplomacy-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('diplomacy-pillars');
    if (!container) return;
    fetch('assets/data/diplomacy.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('diplomacy-search');
    var scopeField = document.getElementById('diplomacy-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('diplomacy-mixed-feed', filtered);
    }
