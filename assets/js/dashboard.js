(function () {
  ...
  function renderPillars() {
    const container = document.getElementById('dashboard-pillars');
    if (!container) return;
    fetch('assets/data/dashboard.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('dashboard-search');
    var scopeField = document.getElementById('dashboard-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('dashboard-mixed-feed', filtered);
    }
