(function () {
  ...
  function renderPillars() {
    const container = document.getElementById('protocol-pillars');
    if (!container) return;
    fetch('assets/data/protocol.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('protocol-search');
    var scopeField = document.getElementById('protocol-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('protocol-mixed-feed', filtered);
    }
