(function () {
  ...
  function renderStats() {
    ...
    if (!container) return;
    fetch('assets/data/structure.json')
  ...
  function renderPillars() {
    const container = document.getElementById('structure-pillars');
    if (!container) return;
    fetch('assets/data/structure.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('structure-search');
    var scopeField = document.getElementById('structure-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('structure-mixed-feed', filtered);
    }
