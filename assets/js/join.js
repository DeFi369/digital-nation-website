(function () {
  ...
  function renderStats() {
    const container = document.getElementById('join-stats');
    if (!container) return;
    fetch('assets/data/join.json')
  ...
  function renderPillars() {
    const container = document.getElementById('join-pillars');
    if (!container) return;
    fetch('assets/data/join.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('join-search');
    var scopeField = document.getElementById('join-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('join-mixed-feed', filtered);
    }
