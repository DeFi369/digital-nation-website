(function () {
  ...
  function renderStats() {
    const container = document.getElementById('charter-addendum-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('charter-addendum-pillars');
    if (!container) return;
    fetch('assets/data/charter-addendum.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('charter-addendum-search');
    var scopeField = document.getElementById('charter-addendum-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('charter-addendum-mixed-feed', filtered);
    }
