(function () {
  ...
  function renderStats() {
    const container = document.getElementById('digital-service-corps-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('digital-service-corps-pillars');
    if (!container) return;
    fetch('assets/data/digital-service-corps.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('digital-service-corps-search');
    var scopeField = document.getElementById('digital-service-corps-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('digital-service-corps-mixed-feed', filtered);
    }
