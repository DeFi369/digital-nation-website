(function () {
  ...
  function renderStats() {
    const container = document.getElementById('manifesto-stats');
    if (!container) return;
    fetch('assets/data/manifesto.json')
  ...
  function renderPillars() {
    const container = document.getElementById('manifesto-pillars');
    if (!container) return;
    fetch('assets/data/manifesto.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('manifesto-search');
    var scopeField = document.getElementById('manifesto-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('manifesto-mixed-feed', filtered);
    }
