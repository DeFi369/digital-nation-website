(function () {
  ...
  function renderStats() {
    const container = document.getElementById('recognition-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('recognition-pillars');
    if (!container) return;
    fetch('assets/data/recognition.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('recognition-search');
    var scopeField = document.getElementById('recognition-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('recognition-mixed-feed', filtered);
    }
