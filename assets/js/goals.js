(function () {
  ...
  function renderPillars() {
    const container = document.getElementById('goals-pillars');
    if (!container) return;
    fetch('assets/data/goals.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('goals-search');
    var scopeField = document.getElementById('goals-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('goals-mixed-feed', filtered);
    }
