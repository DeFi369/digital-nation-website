(function () {
  ...
  function renderStats() {
    const container = document.getElementById('labs-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('labs-pillars');
    if (!container) return;
    fetch('assets/data/labs.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    ...
    var scopeField = document.getElementById('labs-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('labs-mixed-feed', filtered);
    }
