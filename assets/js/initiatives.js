(function () {
  ...
  function renderStats() {
    const container = document.getElementById('initiatives-stats');
    if (!container) return;
    fetch('assets/data/initiatives.json')
  ...
  function renderPillars() {
    const container = document.getElementById('initiatives-pillars');
    if (!container) return;
    fetch('assets/data/initiatives.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('initiatives-search');
    var scopeField = document.getElementById('initiatives-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('initiatives-mixed-feed', filtered);
    }
