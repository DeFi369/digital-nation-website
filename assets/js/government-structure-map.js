(function () {
  ...
  function renderStats() {
    const container = document.getElementById('government-structure-map-stats');
    if (!container) return;
    fetch('assets/data/government-structure-map.json')
  ...
  function renderPillars() {
    const container = document.getElementById('government-structure-map-pillars');
    if (!container) return;
    fetch('assets/data/government-structure-map.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('government-structure-map-search');
    var scopeField = document.getElementById('government-structure-map-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('government-structure-map-mixed-feed', filtered);
    }
