(function () {
  ...
  function renderStats() {
    const container = document.getElementById('situational-awareness-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('situational-awareness-pillars');
    if (!container) return;
    fetch('assets/data/situational-awareness.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    ...
    var scopeField = document.getElementById('situational-awareness-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('situational-awareness-mixed-feed', filtered);
    }
