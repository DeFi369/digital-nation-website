(function () {
  ...
  function renderPillars() {
    const container = document.getElementById('contact-pillars');
    if (!container) return;
    fetch('assets/data/contact.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('contact-search');
    var scopeField = document.getElementById('contact-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('contact-mixed-feed', filtered);
    }
