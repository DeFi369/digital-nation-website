(function () {
  ...
  function renderPillars() {
    const container = document.getElementById('about-pillars');
    if (!container) return;
    fetch('assets/data/about.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('about-search');
    var scopeField = document.getElementById('about-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('about-mixed-feed', filtered);
    }
