(function () {
  ...
  function renderStats() {
    const container = document.getElementById('court-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('court-pillars');
    if (!container) return;
    fetch('assets/data/court.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('court-search');
    var scopeField = document.getElementById('court-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('court-mixed-feed', filtered);
    }
