(function () {
  ...
  function renderStats() {
    const container = document.getElementById('technology-stats');
    if (!container) return;
  ...
  function renderPillars() {
    const container = document.getElementById('technology-pillars');
    if (!container) return;
    fetch('assets/data/technology.json')
      .then(function (res) { return res.json(); })
      .then(function (data) {
  ...
  function initFilters() {
    var searchField = document.getElementById('technology-search');
    var scopeField = document.getElementById('technology-scope');
    ...
    function applyFilter() {
      ...
      renderMixedList('technology-mixed-feed', filtered);
    }
